        ...
        <div class="container">
            <div class="container-fluid">
                <div class="text-center mt-3">
                    <hr class="text-light">
                    <h1>CYBER DC</h1>
                    <h2 class="text-center mt-3">INSTITUTO EDUCATIVO</h2>
                    <hr class="text-light">
                </div>
                <div id="" class="py-5">
                    <div class="container">
                ...
                <div>
                    <div class="row mb-4">
                        <div class="col-lg-6 mt-2">
                            <div class="card h-100">
                                <img src="public/img/Inicio/profesor.jpg" class="card-img-top" alt="Imagen del servicio">
                                <div class="card-body">
                                    <p class="card-text text-center">En nuestro institutos, contamos con un excelente grupo de profesores,
                                        acompañamos
                                        a nuestros estudiantes por una buena educación, de calidad, puedes gestionar la información de los
                                        profesores, los cursos, grupos y
                        ...
                        <div class="col-lg-6 mt-2">
                            <div class="card h-100">
                                <img src="public/img/Inicio/estudiando.jpg" class="card-img-top" alt="Imagen del servicio">
                                <div class="card-body">
                                    <p class="card-text text-center">En nuestro institutos, contamos con un excelente grupo de profesores,
                                        acompañamos
                                        a nuestros estudiantes por una buena educación, de calidad, puedes gestionar la información de los
