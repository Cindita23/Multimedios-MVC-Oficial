...
class EstudiantesModel extends Model{
    ...
    public function insertarEstudiante($datos){
        # INSERT INTO estudiante(id, cedula, correoelectronico, telefono, telefonocelular, 
        #fechanacimiento, sexo, direccion, nombre, apellidopaterno, apellidomaterno, nacionalidad, 
        #idCarreras, usuario) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]','[value-8]','[value-9]','[value-10]','[value-11]','[value-12]','[value-13]','[value-14]')
        try {
            //code...
            $datos['id'] = "0";
